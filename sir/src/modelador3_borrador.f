...
c        xmu=mreadr3(ican,ici,1.0)
	   ...
	   if(pg0.eq.0)pg0=1.e2
	      ...
	      print*,'density boundary condition =',ro0
           ...
           if(ipgmag.eq.1 .and. itautoz_or_ztotau.eq.1 )call equisubmu_contmag(n,tau,t,pe,pg0,pg,z,ro,h,gamma)
           if(ipgmag.eq.1 .and. itautoz_or_ztotau.ne.1 )call equisubmu_contmag_frompgzro(n,tau,t,pe,pg0,pg,z,ro,h,gamma)
           print*,'_________________________________________________________ '
           print*,' '
        else
          print*,'itautoz_or_ztotau=',itautoz_or_ztotau
