...
def _config_MC():
	...
	if instrument == "GRIS":
		noise_I=1e-3
		noise_Q=73e-5 # Computed by using many different quiet sun observations from GRIS
		noise_U=73e-5 # Computed by using many different quiet sun observations from GRIS
		noise_V=70e-5 # Computed by using many different quiet sun observations from GRIS
