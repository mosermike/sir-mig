...
if "-h" in sys.argv or (len(sys.argv) < 5):
	...
	sir.option("[2. Pos]","Observation Profile")
	...
	sir.option("-B","Plot magnetic field strength in Gauss")
	sir.option("-Bz","Plot magnetic field strength in z direction in Gauss")
